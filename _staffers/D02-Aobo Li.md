...
summer: |
  Student should read the TIDMAD paper which describes the dataset: https://openreview.net/pdf?id=GgKHKZgg0Y
  They should also learn coding neural network in PyTorch, a good resource is on my website:
  https://aobol.github.io/AoboLi/#tutorials

time: Tuesday 4pm (subject to change)

modality: In-person (need room booked for me; required if mentoring >4 students in-person)

style: |
  This year my master student Akbota Assan will lead the Capstone team to explore the TIDMAD dataset. Akbota has been working on TIDMAD and understand the technical subtlety, I will provide overall guidance while Akbota helps address technical questions.
