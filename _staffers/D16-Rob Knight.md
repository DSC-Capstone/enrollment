...
title: Applying precision medicine to the world's most important patient - the ocean
...
summer: |
  Familiarity with PyTorch, skbio, MIINT and RYPE would be very helpful. No prior microbiome or multi-omics experience is needed. Prior experience with large dataset visualization would be helpful.

time: 3-4 pm Wednesdays has worked well in the past

modality: In-person (will book own room)

style: |
  Will be integrated with PhD students and postdocs for hands-on work between the weekly class meetings and office hours with me.
