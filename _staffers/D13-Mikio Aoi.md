...
title: Analysis of high-dimensional neural data
...
summer: |
  Please follow this link to a document with reading assignments:
  https://docs.google.com/document/d/1AvxXZ4hkYnj1nY4_fO1s7cP-GI5TZjIGIcrq4bAYbnE/edit?usp=sharing

time: Tuesdays 10-10:50

modality: In-person (need room booked for me; required if mentoring >4 students in-person)

style: |
  I'll be the only person giving instructions. I will be very hands-on in the beginning, providing background and orientation but students will need to choose their own projects and be mostly independent by winter quarter.
